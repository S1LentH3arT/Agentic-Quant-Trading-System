...
path = render_sector_grid(grid_symbols, '电网设备', get_path('tdx-mcp', 'charts', 'grid_test.png'))
print(f'Grid saved: {path}')

# Test individual chart for 601991
print('\nRendering 601991...')
df = load_kline('601991', count=120)
path = render_chart('SSE:601991', df, get_path('tdx-mcp', 'charts', '601991_test.png'))
